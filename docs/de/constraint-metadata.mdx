---
title: Constraint-Metadatensystem
description: >-
...
2. [Erweiterungsstruktur](#extension-structure)
3. [Constraint-Typen](#constraint-types)
4. [Natürlichsprachliche Beschreibungen](#natural-language-descriptions)
5. [Validierungsbeispiele](#validation-examples)
6. [Konfidenzwerte](#confidence-scores)
7. [Discovery-Integration](#discovery-integration)
8. [Werkzeug-Integrationshandbuch](#tool-integration-guide)
...
- Maximal 254 Zeichen
- Beispiel: `admin@example.com`, `api+webhook@example.com`
...
### Beispiel 1: Validierung von DNS-Label-Namen
...
- **Probleme**: Constraint-Genauigkeitsprobleme melden unter https://github.com/f5-sales-demo/api-specs-enriched/issues
...
**Abgeglichene Constraints**: 9.851
