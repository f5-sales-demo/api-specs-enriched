...
- **Applied at:** schema property
- **Purpose:** Valori di esempio illustrativi multipli per una proprietà.
- **Consumers:** multiple
- **Value type:** array
...
- **Applied at:** operation
- **Purpose:** Tempo di risposta misurato empiricamente per questa operazione durante la discovery.
- **Consumers:** multiple
- **Value type:** object
- **Value schema:** `{"type": "object"}`
- **Injected by:** scripts/utils/discovery_enricher.py
...
- **Applied at:** operation
- **Purpose:** Catalogo delle risposte di errore osservate durante la discovery live, con payload di esempio.
- **Consumers:** multiple
- **Value type:** array
- **Value schema:** `{"type": "array", "items": {"type": "object"}}`
- **Injected by:** scripts/utils/discovery_enricher.py
...
- **Applied at:** info
- **Purpose:** Descrizione breve del dominio (~60 caratteri). Si applica anche a livello di proprietà per descrizioni lunghe.
- **Consumers:** multiple
- **Value type:** string
- **Value schema:** `{"type": "string"}`
...
- **Applied at:** info
- **Purpose:** Descrizione media del dominio (~150 caratteri). Si applica anche a livello di proprietà.
- **Consumers:** multiple
- **Value type:** string
- **Value schema:** `{"type": "string"}`
- **Injected by:** scripts/utils/property_description_short_enricher.py
...
- **Applied at:** info
- **Purpose:** Livello minimo di sottoscrizione F5 XC richiesto.
- **Consumers:** multiple
- **Value type:** string
- **Value schema:** `{"type": "string"}`
- **Injected by:** scripts/merge_specs.py
