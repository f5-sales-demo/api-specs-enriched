...
description: >-
  Metadados abrangentes de restrições para geração e validação determinística
  por IA
sidebar:
  order: 2
i18n:
...
3. [Tipos de Restrição](#constraint-types)
...
7. [Integração com Discovery](#discovery-integration)
8. [Guia de Integração com Ferramentas](#tool-integration-guide)
...
- Exemplo: `admin@example.com`, `api+webhook@example.com`
