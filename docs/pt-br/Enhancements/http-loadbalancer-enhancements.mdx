---
title: Aprimoramentos do HTTP LoadBalancer
description: Metadados de enriquecimento para esquemas do HTTP load balancer
sidebar:
  order: 2
i18n:
...
Metadados de enriquecimento para esquemas do HTTP load balancer. Consulte [Extensões OpenAPI](../development/#openapi-extensions) para definições das extensões.
...
- [Guia de Desenvolvimento - Extensões OpenAPI](../development/#openapi-extensions) - Definições e uso das extensões
- [Aprimoramentos do Healthcheck](./healthcheck-enhancements/) - Enriquecimentos do esquema de healthcheck (inclui `x-f5xc-recommended-oneof-variant`)
- [Aprimoramentos do Origin Pool](./originpool-enhancements/) - Enriquecimentos do esquema de origin pool
