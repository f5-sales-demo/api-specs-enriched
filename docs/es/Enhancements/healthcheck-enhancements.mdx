...
Metadatos de enriquecimiento para esquemas relacionados con healthcheck. Consulte [Extensiones de OpenAPI](../development/#openapi-extensions) para las definiciones de extensiones.
...
- [Mejoras de Origin Pool](./originpool-enhancements/) - Enriquecimientos de esquemas de origin pool
