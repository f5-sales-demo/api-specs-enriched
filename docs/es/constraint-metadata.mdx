...
description: >-
  Metadatos completos de restricciones para generación y validación determinista
  con IA
sidebar:
  order: 2
i18n:
...
7. [Integración con descubrimiento](#discovery-integration)
...
- Ejemplo: `admin@example.com`, `api+webhook@example.com`
