...
Immutable release assets are published with each release:

- **Release Asset**: `https://github.com/f5-sales-demo/api-specs-enriched/releases/download/v<VERSION>/f5xc-api-specs-v<VERSION>.zip`
- **Validation Spec Path inside asset**: `domains/validation.json`
