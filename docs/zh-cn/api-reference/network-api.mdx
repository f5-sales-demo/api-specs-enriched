...
- **路径数**：81 | **模式数**：449
- **层级**：高级
- **相关域**：`virtual`、`network_security`、`dns`
...
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/bgp_asn_sets` | 创建 BGP ASN 集。 |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/bgp_asn_sets/&#123;metadata.name&#125;` | 替换 BGP ASN 集。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgp_asn_sets` | 列出 BGP ASN 集。 |
...
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_peers` | 显示 BGP 对等体信息。 |
