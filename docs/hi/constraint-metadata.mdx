---
title: बाधा मेटाडेटा प्रणाली
description: निर्धारक AI जनरेशन और सत्यापन के लिए व्यापक बाधा मेटाडेटा
sidebar:
  order: 2
i18n:
...
- अधिकतम 254 अक्षर
- उदाहरण: `admin@example.com`, `api+webhook@example.com`
...
| पैटर्न | फ़ील्ड नाम Regex | बाधा प्रकार | उदाहरण |
|---------|------------------|-----------------|---------|
...
- **समस्याएं**: https://github.com/f5-sales-demo/api-specs-enriched/issues पर बाधा सटीकता संबंधी समस्याएं रिपोर्ट करें
