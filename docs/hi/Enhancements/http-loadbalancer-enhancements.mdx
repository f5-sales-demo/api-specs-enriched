---
title: HTTP लोडबैलेंसर संवर्द्धन
description: HTTP लोड बैलेंसर स्कीमा के लिए संवर्धन मेटाडेटा
sidebar:
  order: 2
i18n:
...
HTTP लोड बैलेंसर स्कीमा के लिए संवर्धन मेटाडेटा। एक्सटेंशन परिभाषाओं के लिए [OpenAPI Extensions](../development/#openapi-extensions) देखें।
...
- [Development Guide - OpenAPI Extensions](../development/#openapi-extensions) - एक्सटेंशन परिभाषाएँ और उपयोग
- [Healthcheck Enhancements](./healthcheck-enhancements/) - Healthcheck स्कीमा संवर्द्धन (`x-f5xc-recommended-oneof-variant` सहित)
- [Origin Pool Enhancements](./originpool-enhancements/) - ऑरिजिन पूल स्कीमा संवर्द्धन
- [Constraint Metadata Guide](../constraint-metadata/) - विस्तृत बाधा वैलिडेशन दस्तावेज़ीकरण
