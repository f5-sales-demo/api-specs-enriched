...
| POST | `/api/config/namespaces/&#123;namespace&#125;/fleets/&#123;name&#125;/set-log-anonymization` | Log Anonymization Mode. |
...
- [Interactive API Reference](../../../api-reference/ce_management/)
