...
| POST | `/api/config/dns/namespaces/system/dns_zone/import_axfr` | Import AXFR for Primary Zone. |
...
| POST | `/api/config/dns/namespaces/system/dns_zone/initiate_zone_transfer` | Initiate Zone Transfer. |
...
| GET | `/api/config/dns/namespaces/&#123;namespace&#125;/dns_zone/&#123;dns_zone_name&#125;/local_zone_record_names` | GET Local Zone Record Names. |
...
- [Interactive API Reference](../../../api-reference/dns/)
