...
- **log_receiver**: Log receiver for centralized log collection
- **metrics_receiver**: Metrics receiver for centralized metrics collection
- **alert_policy**: Alert policy for monitoring and notification
...
- [Interactive API Reference](../../../api-reference/observability/)
