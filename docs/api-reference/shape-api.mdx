...
| PUT | `/api/shape/bot/namespaces/&#123;namespace&#125;/bot_infrastructures/&#123;name&#125;/apply-certificate` | Apply Certificate. |
...
| PUT | `/api/shape/bot/namespaces/&#123;namespace&#125;/bot_infrastructures/&#123;name&#125;/rollback-certificate-to-default` | Rollback Certificate To Default. |
| GET | `/api/shape/bot/namespaces/&#123;namespace&#125;/ti_packages` | List bot threat intelligence packages. |
...
| DELETE | `/api/shape/csd/namespaces/&#123;namespace&#125;/domains` | Bulk DELETE Domains. |
...
| POST | `/api/shape/csd/namespaces/&#123;namespace&#125;/reports` | Create Report. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/reports-history` | List Reports With History. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/reports/metadata/&#123;job_id&#125;/download` | GET Report Download URL. |
...
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/scripts/overview` | GET Scripts Overview. |
| POST | `/api/shape/csd/namespaces/&#123;namespace&#125;/scripts/&#123;id&#125;/approval-status` | Update Script Approval Status. |
...
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/scripts/&#123;script_id&#125;/inline` | List Inline Scripts. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/add-to-csr` | Add Certificate to CSR. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/add-with-private-key` | Add Certificate with Private Key. |
| GET | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/csr/&#123;csr_id&#125;` | GET CSR By ID. |
| DELETE | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/csr/&#123;csr_id&#125;` | DELETE CSR By ID. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/generate-csr` | Generate CSR. |
| GET | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/list-certificate` | List Certificates. |
| GET | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/list-csr` | List CSR |
| GET | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/&#123;cert_id&#125;` | GET Certificate By ID. |
| DELETE | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/&#123;cert_id&#125;` | DELETE Certificate By ID. |
| PUT | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/&#123;cert_id&#125;/archive` | Archive Certificate By ID. |
| PUT | `/api/shape/bot/namespaces/&#123;namespace&#125;/certificate/&#123;cert_id&#125;/unarchive` | Unarchive Certificate By ID. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/active/ai` | Active AI Known Bot. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/dimension/category` | Known Bot Transactions Per Category. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/dimension/category/actions` | Known Bot Actions Per Category. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/dimension/category/actions/ai` | Known Bot Actions Per AI Category. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/dimension/category/timeseries` | Known Bot Categories Over Time. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/dimension/endpoint` | Known Bot Endpoint. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/known/statistics/overview` | Known Bot Overview Statistics. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v1/reporting/traffic/top/type/known/active` | Top Active Known Bot. |
...
- [Interactive API Reference](../../../api-reference/shape/)
