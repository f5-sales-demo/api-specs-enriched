...
| GET | `/api/sync-cloud-data/namespaces/system/securemesh_site_v2/&#123;site_name&#125;/cloud_resources` | List Cloud Resources. |
...
- [Interactive API Reference](../../../api-reference/sites/)
