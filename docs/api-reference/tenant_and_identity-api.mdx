...
- **user_profile**: User profile with personal settings
...
| GET | `/api/cloud-data/namespaces/system/cloud_user_accounts/&#123;cloud_user_account_name&#125;/onboarded_networks` | GET Onboarded Cloud Networks. |
| GET | `/api/cloud-data/namespaces/system/cloud_user_accounts/&#123;cloud_user_account_name&#125;/validate` | Validates Cloud User Account. |
...
- [Interactive API Reference](../../../api-reference/tenant_and_identity/)
