...
| POST | `/api/infraprotect/namespaces/&#123;metadata.namespace&#125;/infraprotect_packet_captures` | Create DDoS transit Packet Capture. |
| PUT | `/api/infraprotect/namespaces/&#123;metadata.namespace&#125;/infraprotect_packet_captures/&#123;metadata.name&#125;` | Replace DDoS transit Packet Capture. |
| GET | `/api/infraprotect/namespaces/&#123;namespace&#125;/infraprotect_packet_captures` | List Infraprotect Packet Capture. |
| GET | `/api/infraprotect/namespaces/&#123;namespace&#125;/infraprotect_packet_captures/&#123;name&#125;` | GET Infraprotect Packet Capture. |
| DELETE | `/api/infraprotect/namespaces/&#123;namespace&#125;/infraprotect_packet_captures/&#123;name&#125;` | DELETE Infraprotect Packet Capture. |
...
| POST | `/api/infraprotect/namespaces/&#123;namespace&#125;/infraprotect_tunnels/update-tunnel-clear-df-bit` | Update Tunnel Clear DF Bit. |
...
- [Interactive API Reference](../../../api-reference/ddos/)
