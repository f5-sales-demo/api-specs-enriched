...
- [Healthcheck 增強功能](./healthcheck-enhancements/) - 健康檢查結構描述擴充（包含 `x-f5xc-recommended-oneof-variant`）
- [Origin Pool 增強功能](./originpool-enhancements/) - 來源池結構描述擴充
- [約束中繼資料指南](../constraint-metadata/) - 詳細的約束驗證文件
