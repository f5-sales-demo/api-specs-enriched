---
title: مواصفة التحقق
description: هيكل ومحتويات مواصفة التحقق
sidebar:
  order: 3
i18n:
...
- [تحسينات Healthcheck](./Enhancements/healthcheck-enhancements/) - تحسينات مخطط Healthcheck
- [تحسينات Origin Pool](./Enhancements/originpool-enhancements/) - تحسينات مخطط Origin Pool
