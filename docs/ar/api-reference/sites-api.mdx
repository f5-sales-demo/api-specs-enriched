...
description: عمليات نشر العقد السحابية وحافة الشبكة.
sidebar:
  hidden: true
i18n:
...
- نشر F5 XC عبر موفري الخدمات السحابية (AWS وAzure وGCP)
...
- **site**: موقع النشر المادي أو السحابي لخدمات الحافة
...
- [مرجع API التفاعلي](../sites/)
- [مواصفات OpenAPI بتنسيق JSON](../../../specifications/api/sites.json)
